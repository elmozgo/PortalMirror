var weather = {
	...
	temperatureLocation: null, //init this
...
weather.init = function (appId, query, portletDiv) {

	this.params.q = query;
	this.params.APPID = appId;
	this.temperatureLocation = portletDiv.querySelector(".temp");
